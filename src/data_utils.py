...
from data_loader import UNet3DDataset
...
class Dataset(object):
    ...
    def create_pytorch_dataset(self, num_classes=3):
        """
        Creates a Torch DataSet from the DataSet. Note, this has to
